...
DUMMY_DATAFRAME_CONTENT_FAULTY=pd.DataFrame(columns=TEST_CONTENT_COLUMNS, data=[DUMMY_RECORD_CONTENT_T_TYPE, DUMMY_RECORD_CONTENT_LOW_VOTE, DUMMY_RECORD_CONTENT_NA_GENRE, DUMMY_RECORD_CONTENT_NA_TITLE, DUMMY_RECORD_CONTENT_NA_PUBLISHED])
