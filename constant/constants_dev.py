...
DUMMY_RECORD_CONTENT_BAYES=['tt0120737', 8.90000, 2214902, 'The Lord of the Rings: The Fellows', 2001, 'Adventure,Drama, Fantasy', 8.76430, 0.98388, 8.62298, '2026-07-10']
DUMMY_RECORD_CONTENT_BAYES_TWO=['tt0120737', 8.90000, 2214902, 'The Lord of the Rings: The Fellows', 2001, 'Adventure,Drama, Fantasy', 6.76430, 0.98388, 6.65525, '2026-07-10']
DUMMY_RECORD_CONTENT_BAYES_THREE=['tt0120737', 8.90000, 2214902, 'The Lord of the Rings: The Fellows', 2001, 'Adventure,Drama, Fantasy', 9.76430, 0.98388, 9.60689, '2026-07-10']
...
DUMMY_DATAFRAME_CONTENT_BAYES=pd.DataFrame(columns=TEST_CONTENT_BAYES_COLUMNS, data=[DUMMY_RECORD_CONTENT_BAYES, DUMMY_RECORD_CONTENT_BAYES_TWO, DUMMY_RECORD_CONTENT_BAYES_THREE])
...
print(DUMMY_DATAFRAME_CONTENT_BAYES.to_string(index=False))
sorted_fake_df=DUMMY_DATAFRAME_CONTENT_BAYES.sort_values(by=[cons.ADJUSTED_SCORE_COLUMN], ascending=False)
print(sorted_fake_df.to_string(index=False))